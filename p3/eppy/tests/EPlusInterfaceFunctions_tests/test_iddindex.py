...
def test_makename2refdct():
    ...
    expected = {
        ...
        'WALL:EXTERIOR':['SurfaceNames',
                ...
                'SurfGroupAndHTSurfNames',
                'AllShadingAndHTSurfNames'],
        'FENESTRATIONSURFACE:DETAILED':['SubSurfNames',
                'SurfAndSubSurfNames',
                'AllHeatTranSurfNames',
                'OutFaceEnvNames',
                'AllHeatTranAngFacNames',
                ...
                'SurfGroupAndHTSurfNames',
                'AllShadingAndHTSurfNames'],
        'BUILDINGSURFACE:DETAILED':['SurfaceNames',
                'SurfAndSubSurfNames',
                'AllHeatTranSurfNames',
                'HeatTranBaseSurfNames',
                'OutFaceEnvNames',
...
def test_makeref2namesdct():
    ...
    (
        ...
        {'AirflowNetworkNodeAndZoneNames': {'ZONE'},
         'AllHeatTranAngFacNames': {'BUILDINGSURFACE:DETAILED',
          'FENESTRATIONSURFACE:DETAILED',
          'WALL:EXTERIOR',
          'WINDOW'},
         'AllHeatTranSurfNames': {'BUILDINGSURFACE:DETAILED',
          'FENESTRATIONSURFACE:DETAILED',
          'WALL:EXTERIOR',
          'WINDOW'},
         'AllShadingAndHTSurfNames': {'BUILDINGSURFACE:DETAILED',
          'FENESTRATIONSURFACE:DETAILED',
          'WALL:EXTERIOR',
          'WINDOW'},
         'HeatTranBaseSurfNames': {'BUILDINGSURFACE:DETAILED', 'WALL:EXTERIOR'},
         'OutFaceEnvNames': {'BUILDINGSURFACE:DETAILED',
          'FENESTRATIONSURFACE:DETAILED',
          'WINDOW',
          'ZONE'},
         'RadGroupAndSurfNames': {'BUILDINGSURFACE:DETAILED',
          'FENESTRATIONSURFACE:DETAILED',
          'WALL:EXTERIOR',
          'WINDOW'},
         'SubSurfNames': {'FENESTRATIONSURFACE:DETAILED', 'WINDOW'},
         'SurfAndSubSurfNames': {'BUILDINGSURFACE:DETAILED',
          'FENESTRATIONSURFACE:DETAILED',
          'WALL:EXTERIOR',
          'WINDOW'},
         'SurfGroupAndHTSurfNames': {'BUILDINGSURFACE:DETAILED',
          'FENESTRATIONSURFACE:DETAILED',
          'WALL:EXTERIOR',
          'WINDOW'},
