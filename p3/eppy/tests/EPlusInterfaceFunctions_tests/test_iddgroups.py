...
def test_group2commlst():
    ...
    [
     ...
     [['group G1', 'idfobj Version', 'unique-object', 'format singleLine'],
      ['field Version Identifier', 'required-field', 'default 7.0']],
     [['group G1', 'idfobj Version1', 'unique-object', 'format singleLine'],
      ['field Version Identifier', 'required-field', 'default 7.0']],
     [['group G1', 'idfobj Version2', 'unique-object', 'format singleLine'],
      ['field Version Identifier', 'required-field', 'default 7.0']],
     [['group G2', 'idfobj VersionG', 'unique-object', 'format singleLine'],
      ['field Version Identifier', 'required-field', 'default 7.0']],
     [['group G2', 'idfobj VersionG1', 'unique-object', 'format singleLine'],
      ['field Version Identifier', 'required-field', 'default 7.0']],
     [['group G2', 'idfobj VersionG2', 'unique-object', 'format singleLine'],
      ['field Version Identifier', 'required-field', 'default 7.0']]
  ],
    ), # groupcommlst
    )
...
def test_group2commdct():
    ...
    [
     [{'group':None, 'idfobj':'Lead Input'}],
     [{'group':None, 'idfobj':'Simulation Data'}],
     [{'group':'G1', 'idfobj':'Version', 'format': ['singleLine'], 'unique-object': ['']},
      {'default': ['7.0'],
       'field': ['Version Identifier'],
       'required-field': ['']}],
     [{'group':'G1', 'idfobj':'Version1', 'format': ['singleLine'], 'unique-object': ['']},
      {'default': ['7.0'],
       'field': ['Version Identifier'],
       'required-field': ['']}],
     [{'group':'G1', 'idfobj':'Version2', 'format': ['singleLine'], 'unique-object': ['']},
      {'default': ['7.0'],
       'field': ['Version Identifier'],
       'required-field': ['']}],
     [{'group':'G2', 'idfobj':'VersionG', 'format': ['singleLine'], 'unique-object': ['']},
      {'default': ['7.0'],
       'field': ['Version Identifier'],
       'required-field': ['']}],
     [{'group':'G2', 'idfobj':'VersionG1', 'format': ['singleLine'], 'unique-object': ['']},
      {'default': ['7.0'],
       'field': ['Version Identifier'],
       'required-field': ['']}],
     [{'group':'G2', 'idfobj':'VersionG2', 'format': ['singleLine'], 'unique-object': ['']},
      {'default': ['7.0'],
       'field': ['Version Identifier'],
       'required-field': ['']}]],
       ), # groupcommdct
