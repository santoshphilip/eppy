...
# a small hack to start off
import sys
pathnameto_eplusscripting = 'c:/eppy/eplusscripting/'
sys.path.append(pathnameto_eplusscripting) 
# the above lines will let you run your script from anywhere.
# future versions will not need this
...
fname1 = "../idffiles/V_7_2/constructions.idf"
idf1 = IDF(fname1)
...
fname1 = "../idffiles/V_7_0/5ZoneSupRetPlenRAB.idf"
idf1 = IDF(fname1)
...
# Plan loops and diagrams in eppy
