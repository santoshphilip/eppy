...
# python eppyreadtest_file.py '/Applications/EnergyPlus-8-1-0/Energy+.idd' '/Applications/EnergyPlus-8-1-0/ExampleFiles/RetailPackagedTESCoil.idf'
# for non-failure -> SeriesActiveBranch.idf
# python eppyreadtest_file.py '/Applications/EnergyPlus-8-1-0/Energy+.idd' '/Applications/EnergyPlus-8-1-0/ExampleFiles/SeriesActiveBranch.idf'
...
if __name__    == '__main__':
    ...
    parser.add_argument('thefile', action='store', 
